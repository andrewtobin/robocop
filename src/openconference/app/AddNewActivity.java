...
public class AddNewActivity extends TouchActivity {
    ...
    {
    	Intent i = new Intent(AddNewActivity.this, HistoryActivity.class);
    ...
    {
    	Intent i = new Intent(AddNewActivity.this, NewsActivity.class);
    	i.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
		startActivity(i);
    }
    ...
    {
    	Intent i = new Intent(AddNewActivity.this, NearMeActivity.class);
    	i.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
		startActivity(i);
    }
    ...
    {
    	Intent i = new Intent(AddNewActivity.this, TrendingActivity.class);
    	i.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
		startActivity(i);
	}
}    